...
Serial.print("Pesan diterima [");
  ...
  { 
   ...
   if (strcmp(topic, "HILDA311201/lampu3") == 0) //Membandingkan 2 buah String
  { 
    for (int i=0;i<length;i++) {
    char receivedChar = (char)payload[i];
    if (receivedChar == '1'){
...
void pushdata(){
  ...
  //POST TO MQTT
  client.publish("HILDA311201/Flame", String(Flame).c_str()); //Convert to String
...
client.subscribe("HILDA311201/lampu2",0);
client.subscribe("HILDA311201/lampu3",0);
